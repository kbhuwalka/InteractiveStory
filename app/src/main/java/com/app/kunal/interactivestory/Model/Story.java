 ...
 */
public class Story {
    private Page[] storyPages;

    public Story(){
       storyPages = new Page[7];
        storyPages[0] = new Page(
                R.drawable.page0,
